...
ret_type ffmpeg_video_encoder::set_media_type(input_pin* pin,media_type* mt)
{
    media_type* mt_in;
...
ret_type ffmpeg_video_encoder::set_media_type(output_pin* pin,media_type* mt)
{
...
ret_type ffmpeg_video_encoder::process(input_pin* pin,media_frame* frame)
{
