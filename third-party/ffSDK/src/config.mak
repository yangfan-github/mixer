...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--disable-asm --enable-shared
prefix=/usr/local
...
CC_IDENT=gcc 4.8.5 (GCC) 20150623 (Red Hat 4.8.5-36)
ARCH=c
INTRINSICS=none
CC=gcc
CXX=g++
...
EXTRALIBS=-lva -lva-x11 -lva -lxcb -lxcb-shm -lxcb-xfixes -lxcb-shape -lX11 -lm -lz -pthread 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=
